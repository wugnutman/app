  ...
  _renderTextRoom() {
    return (
      <View style={styles.listViewContainer}>
        ...
        />
        <TouchableHighlight
          onPress={this._textRoomPress.bind(self)}>
          <Text>Send</Text>
        </TouchableHighlight>
      </View>
    );
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <TouchableHighlight
            style={{ borderWidth: 2, marginLeft: 15, borderColor: 'black' }}
            onPress={this._switchVideoType.bind(self)}>
        ...
        {this.state.status == 'ready' ?
          (<View>
            ...
            />
            <TouchableHighlight
              style={{ borderWidth: 2, marginTop: 10, borderColor: 'black', justifyContent:'center', alignItems:'center' }}
              onPress={this._press.bind(self)}>
              <Text style={{color: 'red'}}>Enter room</Text>
            </TouchableHighlight>
          </View>) : null
        }
